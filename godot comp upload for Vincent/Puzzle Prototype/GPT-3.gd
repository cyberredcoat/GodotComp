...
func text_entered(text):
	if text != '':
		...
		fetch("https://api.openai.com/v1/completions", ["Authorization:Bearer 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","Content-Type: application/json"], 2, "handle_response",json)
