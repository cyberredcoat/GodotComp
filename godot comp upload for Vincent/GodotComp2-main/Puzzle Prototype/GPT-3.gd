...
func text_entered(text):
	if text != '':
		...
		fetch("https://api.openai.com/v1/completions", ["Authorization:Bearer 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","Content-Type: application/json"], 2, "handle_response",json)
